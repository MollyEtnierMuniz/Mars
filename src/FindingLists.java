...
public class FindingLists {
    public FindingLists() throws InterruptedException {
        ...
        System.out.println("Welcome back from your expedition. Time to catalog everything you nicked. ");
        ...
        System.out.println("Wait--that last one is not a rock. We need to delete if from the list.");
